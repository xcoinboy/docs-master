...
```
 Urbancashd --rpc-bind-port=18889 
```
...
```
 Urbancashd --rpc-bind-ip=0.0.0.0 --rpc-bind-port=18889 
```
...
```
{
  ...
  "params": {
	"blockHashes": [
        ...
        "e711710a8763d5a7bca3bb3fdb6bdf39796ee8612d425eb9c42db7c02216d573"
     ] 
  }
}
```
...
```
{
  ...
  "params": {
    ...
    "address": "URBChnaNiHdEdWcLh8VseUa8Z2fv2e6w2rvWgYySWZaEUMSCHFqhJyhWXY6tUeYsqSZ31QANbaZP6Gm7byZomD4xsc9QMye6ZX",
...
```
{
  ...
  "params": {
    ...
    "destination_address": "URBCiwr4Aajn7QefxbAEvHSAcTrVbhzYukfmbDvwWkrDhjFXe1FVUa5ggxCrEv4w2zvaiVZgoF4v7b3cNAbaU3LKQGS9EU9KAd",
...
```
{
  ...
  "params": {
    ...
    "address": "URBCiwr4Aajn7QefxbAEvHSAcTrVbhzYukfmbDvwWkrDhjFXe1FVUa5ggxCrEv4w2zvaiVZgoF4v7b3cNAbaU3LKQGS9EU9KAd",
...
```
{
  ...
  "params": {
    "address": "URBCd79ZmERRBx3t5uuERi6ggTMMeTBDTLY21cvkEFtE29GY8FJuwQHmWyRxYbPxYBu8S8a7wzxhg3tJfbE27hYGYtbD4mGiSs"
  }
}
```
Output:
...
```
{
  ...
  "jsonrpc": "2.0",
  "result": {
    "address": "URBCetKFqZu4jH9Gnbbvp5ckbXBzadeDK6EFPNFuPcZcCjMDK31r84weVzcF2BhewZEQGZUjDTB7QgHVbJoYTE89eh2ETuDdLH",
    "status": "OK"
  }
}
```
